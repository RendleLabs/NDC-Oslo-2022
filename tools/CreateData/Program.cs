...
var tableServiceClient = new TableServiceClient(Constants.StorageConnectionString);
var toppingsTable = tableServiceClient.GetTableClient(ToppingData.TableName);
await toppingsTable.CreateIfNotExistsAsync();
Console.WriteLine("Created toppings.");
var crustsTable = tableServiceClient.GetTableClient(CrustData.TableName);
await crustsTable.CreateIfNotExistsAsync();
Console.WriteLine("Created crusts.");
Console.WriteLine();
